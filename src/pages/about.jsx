      ...
      <MainLayout>
        <div className="index-container">
          ...
          <div className="content">
            ...
            <h3>Experience</h3>
            <br></br>
            <h4 className="exp"><strong>Researcher (DiSC) - Rutgers University Camden</strong></h4>
            <p className="exp light"><em>January 2019 - Present</em></p>
            ...
            <p className="exp"></p>
            <br></br>
            <h4 className="exp"><strong>Researcher (CCIB) - Rutgers University Camden</strong></h4>
            <p className="exp light"><em>June 2018 - Present</em></p>
